...
import { madeByUser } from '@/services/Videoteca'
...
export const VideotecaComponent = ({ id }) => {
  ...
  const onDrawSold = async () => {
    ...
    const chart = drawBars('bar1', t('charts.videoteca.sold'), t('charts.usuarios'), data1);
    setChart1( chart )    
  }
  ...
  const onDrawFree = async () => {
    ...
    const chart = drawBars('bar2', t('charts.videoteca.free'), t('charts.usuarios'), data1);
    setChart2( chart )
  }
