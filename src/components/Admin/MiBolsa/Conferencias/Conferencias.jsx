...
import { madeByUser } from '@/services/Conferencias'
...
export const ConferenciasComponent = () => {
  ...
  const onDrawSold = async () => {
    ...
    const chart = drawBars('bar1', t('charts.conferencias.sold'), t('charts.usuarios'), data1);
    setChart1( chart )    
  }
  ...
  const onDrawFree = async () => {
    ...
    const chart = drawBars('bar2', t('charts.conferencias.free'), t('charts.usuarios'), data1);
    setChart2( chart )
  }
