                                    ...
                                    <div className="form">
                                        <div className="mb-3 row">
                                            <div className="col-md-6 col-12">
                                                <label htmlFor="staticEmail" className='form-label'> { t('profile.form.country') }</label>
                                                <CountryDropdown
                                                    required
                                                    name='pais'
                                                    defaultOptionLabel={ t('profile.form.chose') }
                                                    classes={`form-control ${styles.country}`}
                                                    value={formState.pais}
                                                    onChange={(val) => selectCountry(val)} />
                                            </div>
                                            <div className="col-md-6 col-12">
                                                <label htmlFor="staticEmail" className="form-label">{t('form.form.keywords')}:</label>
                                                <Select
                                                    className=''
                                                    required
                                                    name='tags'
                                        ...
                                        <div className="mb-3 row">
                                            <div className="col-md-6 col-12">
                                                <label htmlFor="staticEmail" className="form-label">{t('form.form.name')}:</label>
                                                <input type="text" 
                                                    required
                                                    name='name'
                                            ...
                                            <div className="col-md-6 col-12">
                                                <label htmlFor="staticEmail" className="form-label">{t('form.form.email')}: </label>
                                                <input type="email"
                                                    required
                                                    name='email'
                                                    className="form-control"
                                        ...
                                        <div className="mb-3 row">
                                            <div className="col-12">
                                                <label htmlFor="staticEmail" className="form-label">{t('form.form.case')}: </label>
